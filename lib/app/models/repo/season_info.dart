...
SeasonInfoModelsuper seriesInfoModelFromJson(String str) =>
    SeasonInfoModelsuper.fromJson(json.decode(str));

String seriesInfoModelToJson(SeasonInfoModelsuper data) =>
    json.encode(data.toJson());

class SeasonInfoModelsuper {
  List<Season>? seasons;
  SeriesInfoModelInfo? info;
  Map<String, List<Episode>>? episodes;

  SeasonInfoModelsuper({
    this.seasons,
    this.info,
    this.episodes,
  });

  factory SeasonInfoModelsuper.fromJson(Map<String, dynamic> json) =>
      SeasonInfoModelsuper(
        seasons:
...
class Episode {
  ...
  factory Episode.fromJson(Map<String, dynamic> json) => Episode(
        ...
        info: InfoInfo.fromJson(json["info"] ?? {}),
